...
exports.transferFunds = async (req, res) => {
    ...
    try{
        // Validate accounts
        const sender = await Account.findOne({where: {accountNumber: senderAccount, userID: userId}
        });
        ...
        const receiver = await Account.findOne({where: {accountNumber: receiverAccount}}) 
